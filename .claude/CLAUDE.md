...
You are working inside the **Construction AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for contractors. It contains:
...
- Industry page: https://krasa.ai/industries/construction
