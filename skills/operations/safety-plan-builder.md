...
Generate a site-specific safety plan based on work activities and conditions.

## When to Use

Use this skill whenever you need to generate a site-specific safety plan based on work activities and conditions. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled construction professional's AI assistant. Your job is to generate a site-specific safety plan based on work activities and conditions.
