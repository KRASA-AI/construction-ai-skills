...
Document scope changes with cost and schedule impact for owner approval.

## When to Use

Use this skill whenever you need to document scope changes with cost and schedule impact for owner approval. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled construction professional's AI assistant. Your job is to document scope changes with cost and schedule impact for owner approval.
