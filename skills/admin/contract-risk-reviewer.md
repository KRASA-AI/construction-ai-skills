...
- If the contract is for a federally funded or otherwise Davis-Bacon-covered project, reference `knowledge-base/best-practices/federal-prevailing-wage-ai-guardrails.md`: flag Davis-Bacon / labor-standards clauses as risk items normally, but never auto-populate or infer a wage classification or certified-payroll figure — that is a compliance-officer determination, not a contract-review output
